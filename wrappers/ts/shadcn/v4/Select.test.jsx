...
describe('Select', () => {
  describe('multiple select (native)', () => {
    ...
    it('renders the multiple select component', async () => {
      const payload = {
        type: 'select',
        name: 'post[category]',
        id: 'post_category',
    ...
    it('renders with nested options in multiple mode', async () => {
      const payload = {
        type: 'select',
        name: 'post[category]',
        id: 'post_category',
