...
import { Checkbox as MantineCheckbox, Radio as MantineRadio, Group as MantineGroup, Input as MantineInput, TextInput as MantineTextInput, ColorInput as MantineColorInput, NumberInput as MantineNumberInput, PasswordInput as MantinePasswordInput, Slider as MantineSlider, Select as MantineSelect, MultiSelect as MantineMultiSelect, Textarea as MantineTextArea, FileInput as MantineFileInput, Button as MantineButton, } from '@mantine/core';
...
export const MultiSelect = (props) => {
    ...
    hiddenInputProps={{ name: '_IGNORE' }} {...props}/>
      {values.map((val) => (<input type="hidden" key={String(val)} name={name} value={String(val)} autoComplete="off"/>))}
    </>);
};
/**
...
export const RangeField = ({ type: _type, errorKey, label, ...rest }) => {
    const errorMessage = useErrorMessage(errorKey);
    return (<MantineInput.Wrapper label={label} error={errorMessage}>
      <MantineSlider {...rest}/>
